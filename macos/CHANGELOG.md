...
> **世事宜AI 发行版 v2.0.0（2026-07-17）**：基于上游 Codex Dream Skin Studio 1.2.0
> （https://github.com/Fei-Away/Codex-Dream-Skin ，MIT）。差异：移除上游维护者提供的
> 「浪漫玫瑰」照片类素材，新增程序化生成的置顶预设「世事宜梦境」（preset-ssyai-dream），
> promo 元数据指向世事宜AI，移除仓库打包脚本。以下为上游引擎原始更新记录。
