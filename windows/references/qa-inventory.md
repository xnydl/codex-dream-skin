...
- Tray lifecycle: pause/resume reflects the clicked state, bundled 世事宜梦境 preset is present on first install, and complete restore terminates any separately launched tray before it can reapply the skin.
