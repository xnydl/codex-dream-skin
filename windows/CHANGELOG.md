...
> **世事宜AI 发行版 v2.0.0（2026-07-17）**：基于上游 1.2.0。差异：默认主题与
> 「已保存主题」预置从「浪漫玫瑰」换为程序化生成的「世事宜梦境」（preset-ssyai-dream，
> `assets/dream-reference.jpg` 为 2560 × 1440 抽象光晕图，与 macOS 同源同字节），
> 其余引擎行为一致。以下为上游引擎原始更新记录。
